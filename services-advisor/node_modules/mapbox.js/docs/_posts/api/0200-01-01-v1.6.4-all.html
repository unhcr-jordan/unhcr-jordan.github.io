---
layout: api
title: "v1.6.4 JavaScript Library: All"
categories: api
version: v1.6.4
...
interactivity.</p>
<p><span class='leaflet'><em>Extends</em>: <code><a href="#l-map-class">L.Map</a></code></span></p>
<table>
<thead>
<tr>
<th>Options</th>
...
<p><span class='leaflet'><em>Extends</em>: <code><a href="#l-tilelayer">L.TileLayer</a></code></span></p>
<table>
<thead>
<tr>
<th>Options</th>
...
<td>options</td>
<td>object</td>
<td>The second argument is optional. If provided, it is the same options as provided to <code><a href="#l-tilelayer">L.TileLayer</a></code> with one addition: <ul><li><code>retinaVersion</code>, if provided, is an alternative value for the first argument to <code><a href="#l-mapbox-tilelayer">L.mapbox.tileLayer</a></code> which, if retina is detected, is used instead.</li></ul></td>
</tr>
</tbody>
</table>
...
<p><span class='leaflet'><em>Extends</em>: <code><a href="#l-featuregroup">L.FeatureGroup</a></code></span></p>
<p><strong>NOTE: in version 1.6.0, <code><a href="#l-mapbox-markerlayer">L.mapbox.markerLayer</a></code> was renamed to <code><a href="#l-mapbox-featurelayer">L.mapbox.featureLayer</a></code>
to signal the addition of support for lines and polygons. The <code><a href="#l-mapbox-markerlayer">L.mapbox.markerLayer</a></code>
...
<h2 id="l-mapbox-geocoder">L.mapbox.geocoder(id|url)</h2>
...
<p><span class='leaflet'><em>Extends</em>: <code><a href="#l-control">L.Control</a></code></span></p>
...
This function is currently in private beta: <a href="https://mapbox.com/contact/">Contact Mapbox</a> before using this functionality.
</div>
...
<td>options</td>
<td>object</td>
<td>An options argument with the same options as the <code><a href="#l-control">L.Control</a></code> class, as well as: <ul><li><code>keepOpen</code>: a boolean for whether the control will stay open always rather than being toggled. Default <code>false</code>. See <a href='https://www.mapbox.com/mapbox.js/example/v1.0.0/geocoder-keep-open/'>live example</a>.<li></ul></td>
</tr>
</tbody>
</table>
<p><em>Example</em>:</p>
...
<td>event</td>
<td>string</td>
<td><ul><li><code>select</code>: fired when the user selects a location from a list of options returned from a geocoding request. The geocoding data is attached to the <code>data</code> property of the event.</td>
</tr>
<tr>
<td>event</td>
<td>string</td>
<td><ul><li><code>autoselect</code>: fired when the geocoder control automatically chooses the first result of a query that returns only one result, and repositions the map accordingly. The geocoding data is attached to the <code>data</code> property of the event.</td>
</tr>
</tbody>
</table>
...
<td>options</td>
<td>object</td>
<td>Options for L.Control</span> Also accepts the following options:<ul><li>url: the <code>URL</code> of a page to which the share control will link instead of the URL of the current page or that specified in TileJSON data.</li></ul></td>
</tr>
</tbody>
</table>
<p><em>Example</em>:</p>
...
</code></pre><h2 id="l-mapbox-config-http_urls">L.mapbox.config.HTTP_URLS</h2>
...
<h2 id="l-mapbox-config-https_urls">L.mapbox.config.HTTPS_URLS</h2>
<p>The same as <code><a href="#l-mapbox-config-http_urls">L.mapbox.config.HTTP_URLS</a></code>, but used when SSL mode is detected or
...
<pre><code>var map = L.mapbox.map(&#39;map&#39;, &#39;your.mapid&#39;, {
    tileLayer: {
        detectRetina: true,
        retinaVersion: &#39;your.mapid&#39;
    }
}).setView([40, -74.50], 9);
</code></pre><p>Some Mapbox maps support switching to retina scale automatically: if you&#39;re using
one of these maps, you can simply set <code>detectRetina</code> and the higher-scale
...
</code></pre><h2 id="theming">Theming</h2>
